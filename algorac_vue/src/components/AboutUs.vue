    ...
    <div class="container mx-auto text-left text-white">
      <div class="flex items-center">
        <div class="w-1/2">
          ...
          <a class="bg-gray-500 text-white py-4 px-12 rounded-full hover:bg-white-600"><i>ALGORAC believes in coding the
              problems away.</i></a>
        </div>
        <div class="w-1/2 px-2">
          <div class="shadow-2xl border-1 mx-auto my-20 border rounded-lg backdrop-blur-lg">
            <div class="p-5 space-y-5 shadow-xl">
              <h4 class="font-serif text-center text-3xl">Send Queries</h4>

              <form>
                <div class="grid text-gray-900 grid-cols-2 gap-5">
                  <input type="text"
                  ...
                  <div class="mt-15 text-gray-200">
                    <input type="checkbox" class="border border-gray-400" />
                    <span>
                      I accept the
                      <a href="#" class="text-green-500 font-semibold">Term of Use</a>
                      &<a href="#" class="text-green-500 font-semibold">Private Policy</a></span>
                  </div>
                </div>
                <input type="submit" value="Send Message"
                  class="cursor-pointer focus:outline-none mt-5 bg-sky-900 px-4 py-2 text-white font-bold w-full" />
              </form>
            </div>
          </div>
        </div>
